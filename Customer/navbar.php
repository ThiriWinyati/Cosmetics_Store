            ...
            <ul class="navbar-nav ms-auto align-items-lg-center">
                    ...
                    <div class="dropdown-menu dropdown-menu-end" id="wishlistDropdown">
                        ...
                        <?php if (!empty($wishlistItems)): ?>
                            <?php foreach ($wishlistItems as $item): ?>
                                <div class="dropdown-item d-flex justify-content-between gap-3">
                ...
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="account">
                        <?php if (isset($_SESSION['is_logged_in']) && $_SESSION['is_logged_in'] === true): ?>
                            <li>
                                <a class="dropdown-item" href="/Customer/userProfile.php">My Profile</a>
                            </li>

                            <li>
                                <a class="dropdown-item" href="/Customer/orderHistory.php">Order History</a>
                            </li>

                            <li>
                                <a class="dropdown-item" href="/Customer/user_logout.php">Logout</a>
                            </li>
                        <?php else: ?>
                            <li>
                                <a class="dropdown-item" href="/Customer/user_login.php">Login</a>
                            </li>
                        <?php endif; ?>
                    </ul>
                </li>
